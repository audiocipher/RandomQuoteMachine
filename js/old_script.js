...
var update_href = function(){
  let elTweet = document.getElementById('tweet'); // reference to the DOM element
  ...
  elTweet.setAttribute('href', the_url);
}
...
var el_quotation = document.getElementById('quotation'); // cache DOM element
var el_source = document.getElementById('source');

el_quotation.textContent = current_quote.getQuote();
el_source.textContent = current_quote.getSource();
...
var el_button = document.getElementById('new-quote');
el_button.addEventListener('click', change_quote, false);
